    ...
    function render() {
        ...
        panel.innerHTML =
            '<div class="h3ct-layout">' +
                ...
                '<div><div class="h3ct-eyebrow">Diffusion Compiler H3 inference</div>' +
                ...
                '<div id="h3ct-model-note" class="h3ct-note">Reading installed Diffusion Compiler H3 models…</div>' +
                ...
                '</div>' +
                '<div class="h3ct-note">Long control video trims; short video visibly holds its last frame.</div>' +
                ...
                '</div>' +
                '<section class="h3ct-recent"><div class="h3ct-stage-head"><div><span>Recent video outputs</span><strong>Compiler inference outputs</strong></div><button id="h3ct-refresh-recent" class="h3ct-text-button" type="button">Refresh</button></div><div id="h3ct-recent-list" class="h3ct-recent-list"><span>Loading recent outputs…</span></div></section>' +
    ...
    function loadRecent() {
        ...
        fetch('/output_files', { cache: 'no-store' }).then(function (response) {
            ...
            if (!state.recent.length) {
                els.recentList.innerHTML = '<span>No compiler video outputs found yet.</span>';
                return;
            }
