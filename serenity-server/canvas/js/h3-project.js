...
var H3ProjectContracts = (function () {
    ...
    function compilePrompt(shot, project) {
        ...
        // Ref2VA contract, and a restored shot rendered as the wrong scene
        // entirely (video-0064). Cast identity is enforced through the
        // references the request carries, not by destroying authored text; a
        // shot whose prompt should follow the cast simply has no override.
